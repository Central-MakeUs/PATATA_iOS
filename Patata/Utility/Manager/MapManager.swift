...
final class MapManager: NSObject, ObservableObject, NMFMapViewTouchDelegate, CLLocationManagerDelegate {
...
extension MapManager: NMFMapViewCameraDelegate {
...
extension MapManager {
    static let spotMapShared = MapManager()
    static let addSpotShared = MapManager()
    static let searchMapShared = MapManager()
}
